...
def nmapScan(ip_address):
   ...
   print "INFO: Running -T 5 general TCP/UDP nmap scans for " + ip_address
   serv_dict = {}
   TCPSCAN = "nmap -vv -Pn -A -sC -sS -T 5 -p- -oN '/root/scripts/recon_enum/results/exam/%s_T5.nmap' -oX '/root/scripts/recon_enum/results/exam/nmap/%s_T5_nmap_scan_import.xml' %s"  % (ip_address, ip_address, ip_address)
   UDPSCAN = "nmap -vv -Pn -A -sC -sU -T 5 --top-ports 200 -oN '/root/scripts/recon_enum/results/exam/%sU_T5.nmap' -oX '/root/scripts/recon_enum/results/exam/nmap/%sU_T5_nmap_scan_import.xml' %s" % (ip_address, ip_address, ip_address)
